# Research Prompt 1: GDD Review and Core Vision Synthesis

## 1. Objective

To perform a comprehensive review of the "Reality Check" Game Design Document (GDD), evaluate its structure and clarity against industry best practices, and synthesize its core vision into a clear, actionable summary for the development team.

## 2. Context: The Game

"Reality Check" is a satirical, narrative-driven board game for 3-5 players that mirrors the complexities of modern adult life. Players must balance four core stats (Money, Mental Health, Sin, and Virtue) while navigating various life events through card-based choices. The game aims to generate memorable stories and conversations, with multiple, value-driven victory conditions.

## 3. Provided Document: Game Design Document (GDD)
...
1.  **Core Vision Synthesis:**
    *   Based on the GDD, what is the "player fantasy"? What feeling or experience is this game trying to evoke?
    *   Who is the likely target audience for this game?
    *   Synthesize the game's vision into a single, compelling "elevator pitch" (2-3 sentences).

2.  **GDD Structure and Clarity Review:**
    *   How does this GDD stack up against industry best practices for a "living document"?
    *   What sections are well-defined? What key sections, if any, are missing (e.g., Target Audience, Monetization Strategy, Art Style Guide)?
    *   Is the information well-organized and easy to find? Suggest at least two improvements to the document's structure or formatting (e.g., adding a table of contents, using diagrams for complex loops).

3.  **Potential Risks and Ambiguities:**
    *   Identify the top 3 potential risks to the project based on this GDD. These could be risks related to game balance, player experience, or implementation complexity.
    - For each risk, briefly explain why it is a concern.
    *   Are there any rules or concepts in the GDD that are ambiguous or could be misinterpreted by the development team? Please list them and explain the potential for confusion.
